 ...
 * DemandeFormation
 *
 * @ORM\Table(name="demande_formation")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\DemandeFormationRepository")
 * @ORM\InheritanceType("SINGLE_TABLE")
 */
class DemandeFormation extends GenericEntity
{
    /**
     * @var string
     *
