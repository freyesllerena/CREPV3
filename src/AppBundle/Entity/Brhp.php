 ...
 *
 * @ORM\Table(name="brhp")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\BrhpRepository")
 */
class Brhp extends Personne
{
    /**
     * @var Utilisateur
    ...
    /**
     * @ORM\ManyToMany(targetEntity="AppBundle\Entity\PerimetreBrhp", inversedBy="brhps")
     * @ORM\JoinTable(name="brhp_perimetres_brhp")
