 ...
 * CrepMinefContract.
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepMinefContractRepository")
 */
class CrepMinefContract extends Crep
{
    /**
     ...
     * @Assert\Length(
     *      max = 30,
     *      maxMessage = "La catégorie de l'emploi ne doit pas dépasser {{ limit }} caractères"
     * )
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="CrepMinefContractCompetenceTransverse", mappedBy="crep", cascade={"persist"}, orphanRemoval=true)
     * @Assert\Valid
     */
    ...
    public function initialiser(Agent $agent, $em)
    {
        ...
        foreach ($transverses as $transverse) {
            $competenceTransverse = new CrepMinefContractCompetenceTransverse();
...
//        $shd = $this->setAgent()->getShd();
//        $nomShd = $shd->getNom();
//        $this->setShdSignataire($shd);
    }
     ...
     *
     * @param CrepMinefContractCompetenceTransverse $competencesTransverse
     *
     * @return CrepMinefContract
     */
    public function addCompetencesTransverse(CrepMinefContractCompetenceTransverse $competencesTransverse)
    {
        $this->competencesTransverses[] = $competencesTransverse;
        $competencesTransverse->setCrepMinefContract($this);
     ...
     * @param CrepMinefContractCompetenceTransverse $competencesTransverse
     */
    public function removeCompetencesTransverse(CrepMinefContractCompetenceTransverse $competencesTransverse)
    {
        $this->competencesTransverses->removeElement($competencesTransverse);
        $competencesTransverse->setCrepMinefContract(null);
    }
     ...
     * @Assert\Callback
     */
    public function validateCrepMinefContract(ExecutionContextInterface $context)
    {
    ...
    public function confidentialisationChampsShd()
    {
        ...
        /* @var $transverse CrepMinefContractCompetenceTransverse */
