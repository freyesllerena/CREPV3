...
/**
 * CrepAcCompetenceManageriale.
 *
 * @ORM\Table(name="crep_ac_comp_manager")
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepAcCompetenceManagerialeRepository")
 *
 * @ORM\InheritanceType("SINGLE_TABLE")
 */
class CrepAcCompetenceManageriale
{
    /**
     * @var int
     *
