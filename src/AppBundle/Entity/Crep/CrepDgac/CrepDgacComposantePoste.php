...
/**
 * CrepDgacComposantePoste.
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepRepository\CrepDgacRepository\CrepDgacComposantePosteRepository")
 */
class CrepDgacComposantePoste extends Competence
{
	/**
	 * @var text
	 *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="CrepDgac", inversedBy="composantesPostes")
     */
    protected $crep;
