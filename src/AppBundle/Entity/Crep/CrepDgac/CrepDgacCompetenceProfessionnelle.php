...
/**
 * CrepDgacCompetenceProfessionnelle.
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepRepository\CrepDgacRepository\CrepDgacCompetenceProfessionnelleRepository")
 */
class CrepDgacCompetenceProfessionnelle extends Competence
{
	/**
	 * @var text
	 *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="CrepDgac", inversedBy="competencesProfessionnelles")
     */
    protected $crep;
