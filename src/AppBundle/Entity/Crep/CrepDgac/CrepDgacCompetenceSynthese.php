...
/**
 * CrepDgacCompetenceSynthese.
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepRepository\CrepDgacRepository\CrepDgacCompetenceSyntheseRepository")
 */
class CrepDgacCompetenceSynthese extends Competence
{
	/**
	 * @var text
	 *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="CrepDgac", inversedBy="competencesSyntheses")
     */
    protected $crep;
