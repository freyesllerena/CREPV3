 ...
 * AutreDomaine.
 *
 * @ORM\Table(name="autre_domaine")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\AutreDomaineRepository")
 */
class AutreDomaine
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="CrepMindef01", inversedBy="autresDomaines")
     */
