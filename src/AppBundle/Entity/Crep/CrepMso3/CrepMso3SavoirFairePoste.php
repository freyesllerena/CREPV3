 ...
 * CompetencePoste.
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepMso3SavoirFairePosteRepository")
 */
class CrepMso3SavoirFairePoste extends CrepMso3Competence
{
    /**
     * @ORM\ManyToOne(targetEntity="CrepMso3", inversedBy="savoirsFairePoste")
     */
    protected $crep;
