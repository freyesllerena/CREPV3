 ...
 * CompetencePoste.
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepMso3QualiteRelationnellePosteAutreRepository")
 */
class CrepMso3QualiteRelationnellePosteAutre extends CrepMso3Competence
{
    /**
     * @ORM\ManyToOne(targetEntity="CrepMso3", inversedBy="qualitesRelationnellesPosteAutres")
     */
    protected $crep;
