 ...
 * CompetencePoste.
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepMso3CompetenceRequiseRepository")
 */
class CrepMso3CompetenceRequise extends CrepMso3Competence
{
    /**
     * @ORM\ManyToOne(targetEntity="CrepMso3", inversedBy="competencesRequises")
     */
    protected $crep;
     ...
     *
     * @return CrepMso3CompetenceRequise
     */
