 ...
 * CompetenceAgent.
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepMso3SavoirFaireAgentRepository")
 */
class CrepMso3SavoirFaireAgent extends CrepMso3Competence
{
    /**
     * @ORM\ManyToOne(targetEntity="CrepMso3", inversedBy="savoirsFaireAgent")
     */
    protected $crep;
