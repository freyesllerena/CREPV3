 ...
 * CompetencePoste.
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepMso3CompetenceMiseEnOeuvreRepository")
 */
class CrepMso3CompetenceMiseEnOeuvre extends CrepMso3Competence
{
    /**
     * @ORM\ManyToOne(targetEntity="CrepMso3", inversedBy="competencesMisesEnOeuvre")
     */
    protected $crep;
