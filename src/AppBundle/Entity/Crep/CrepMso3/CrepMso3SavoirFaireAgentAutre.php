 ...
 * CompetenceAgent.
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepMso3SavoirFaireAgentAutreRepository")
 */
class CrepMso3SavoirFaireAgentAutre extends CrepMso3Competence
{
    /**
     * @ORM\ManyToOne(targetEntity="CrepMso3", inversedBy="savoirsFaireAgentAutres")
     */
    protected $crep;
