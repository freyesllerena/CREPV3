 ...
 * CompetenceAgent.
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepRepository\CrepMso3Repository\CrepMso3FormationT3Repository")
 */
class CrepMso3FormationT3 extends CrepMso3Formation
{
    /**
     * @ORM\ManyToOne(targetEntity="CrepMso3", inversedBy="formationsT3")
     */
    protected $crep;
