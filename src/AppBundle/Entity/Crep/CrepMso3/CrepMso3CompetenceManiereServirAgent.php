 ...
 * CompetencePoste.
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepMso3CompetenceManiereServirAgentRepository")
 */
class CrepMso3CompetenceManiereServirAgent extends CrepMso3Competence
{
    /**
     * @ORM\ManyToOne(targetEntity="CrepMso3", inversedBy="competencesManiereServir")
     */
    protected $crep;
