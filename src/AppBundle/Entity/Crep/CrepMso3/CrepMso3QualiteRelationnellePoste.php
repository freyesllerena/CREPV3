 ...
 * CompetencePoste.
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CrepMso3QualiteRelationnellePosteRepository")
 */
class CrepMso3QualiteRelationnellePoste extends CrepMso3Competence
{
    /**
     * @ORM\ManyToOne(targetEntity="CrepMso3", inversedBy="qualitesRelationnellesPoste")
     */
    protected $crep;
