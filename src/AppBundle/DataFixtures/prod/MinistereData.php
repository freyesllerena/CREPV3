...
class MinistereData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $ministere13 = new Ministere();
        $ministere13->setLibelleCourt('Finances SCL')
        ->setLibelleLong('Service commun des laboratoires')
        ->setLibelleOfficiel('Service commun des laboratoires');
        $manager->persist($ministere13);
        ...
        $this->addReference('ministere13', $ministere13);
    }
