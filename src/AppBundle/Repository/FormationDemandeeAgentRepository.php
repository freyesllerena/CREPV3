...
/**
 * FormationDemandeeAgentRepository.
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class FormationDemandeeAgentRepository extends \Doctrine\ORM\EntityRepository
{
    public function exportFormations(CampagneBrhp $campagneBrhp, $modeleCrep)
    {
        ...
        ->addSelect('formation.typologie as f_typologie, formation.libelle as f_libelle, formation.code as f_code, formation.priorite as f_priorite, formation.niveauSame as f_niveauSame, formation.dif as f_dif')
