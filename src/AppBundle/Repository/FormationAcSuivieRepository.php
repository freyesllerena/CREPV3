...
/**
 * FormationAcSuivieRepository.
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class FormationAcSuivieRepository extends \Doctrine\ORM\EntityRepository
{
    public function exportFormations(CampagneBrhp $campagneBrhp, $modeleCrep)
    {
        ...
        ->addSelect('formation.libelle as f_libelle, formation.annee as f_annee, formation.duree as f_duree, formation.commentaires as f_commentaires')
