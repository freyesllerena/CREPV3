...
class CrepMinefAbcManager extends BaseManager
{
    protected $modeleCrep = 'AppBundle\Entity\Crep\CrepMinefAbc\CrepMinefAbc';
    ...
    private function exportFormationsSuivies(CampagneBrhp $campagneBrhp)
    {
        ...
        fputcsv($handle, array('Matricule', 'Email', 'Civilité', 'Nom', 'Prénom', 'Catégorie', 'Corps', 'Grade', 'Affectation', 'Intitulé de la formation', 'Date signature définitive du CREP', 'Date refus signature du CREP'), ';');
